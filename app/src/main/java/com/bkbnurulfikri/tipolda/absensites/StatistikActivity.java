...
public class StatistikActivity extends AppCompatActivity implements OnItemSelectedListener {
    ...
    private class AsyncRetrieve extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(StatistikActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://kb.nurulfikri.id/api/android/revenue/revenue-fetch.php");
        ...
        protected void onPostExecute(String result) {
            ...
            {
                Toast.makeText(StatistikActivity.this,"Connection Problem. Http is not ok.",Toast.LENGTH_LONG).show();

            }else if(result.equals("error")){

                Toast.makeText(StatistikActivity.this,"Possibly Exception! Check your terminal for errors.",Toast.LENGTH_LONG).show();
